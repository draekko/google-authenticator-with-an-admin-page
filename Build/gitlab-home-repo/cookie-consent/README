...
This plugin displays an unobtrusive information bar at the top of the page informing the user about the site's use of cookies. This approach follows an consent model. It doesn't explicitly ask the user for consent before placing cookies, it merely infoms them about the use of cookies. When the user navigates to a second page or clicks on the dismiss button, the bar is hidden. This approach is similar to that used on many government websites including gov.uk. 
...
Yes, you can get a handle via the 'cc_message' CSS ID:
